...
setup(name='chattyraspi-freenove-demo1',
      version='0.0.1',
      description='Chattyraspi demo using freenove FNK0024',
      long_description=readfile('README.rst'),
      url='https://github.com/fcracker79/alexa-home-skill/demo/chattyraspi-freenove-demo1',
      author='fcracker79',
      author_email='fcracker79@gmail.com',
      license='MIT',
      packages=['chattyraspi_demo'],
